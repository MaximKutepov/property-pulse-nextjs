        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          ...
          <div>
            <input
              ...
              value="Grill"
              className="mr-2 accent-blue-500"
              defaultChecked={property.amenities.includes("Grill")}
            />
            <label htmlFor="Outdoor_Grill_BBQ">Outdoor Grill/BBQ</label>
          </div>
          <div>
            <input
              type="checkbox"
              id="High-Speed_Internet"
              name="amenities"
              value="Internet"
              className="mr-2 accent-blue-500"
              defaultChecked={property.amenities.includes("Internet")}
            />
            <label htmlFor="High-Speed_Internet">High-Speed Internet</label>
          </div>
          <div>
            <input
              type="checkbox"
      ...
      <div className="mb-4 bg-blue-50 p-4">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          <div className="flex items-center">
            <label htmlFor="weekly_rate" className="mr-2 accent-blue-500">
              Weekly
            </label>
            <input
              type="number"
          ...
          <div className="flex items-center">
            <label htmlFor="monthly_rate" className="mr-2 accent-blue-500">
              Monthly
            </label>
            <input
              type="number"
          ...
          <div className="flex items-center">
            <label htmlFor="nightly_rate" className="mr-2 accent-blue-500">
              Nightly
            </label>
            <input
              type="number"
